...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210705_ashifa_9f7ba95f76d9d9b77958_20210705130419_archive.zip';
	const ARCHIVE_SIZE		 = '73117810';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '9f7ba95-05130419';
    const SECONDARY_PACKAGE_HASH = '1b910b8-05130419';
	const VERSION			 = '1.4.1';
